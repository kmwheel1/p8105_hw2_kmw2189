...
## Creating popular name tables

``` r
##Creating Olivia table
Olivia_name = baby_names %>% 
  filter(name == "Olivia")  
   
knitr::kable(Olivia_name,
      caption = "Rank of Female Children in NYC Named Olivia")
```

| gender | ethnicity                  | name   | 2016 | 2015 | 2014 | 2013 | 2012 | 2011 |
| :----- | :------------------------- | :----- | ---: | ---: | ---: | ---: | ---: | ---: |
| FEMALE | ASIAN AND PACIFIC ISLANDER | Olivia |    1 |    1 |    1 |    3 |   NA |   NA |
| FEMALE | BLACK NON HISPANIC         | Olivia |    8 |    4 |    8 |    6 |   NA |   NA |
| FEMALE | HISPANIC                   | Olivia |   13 |   16 |   16 |   22 |   NA |   NA |
| FEMALE | WHITE NON HISPANIC         | Olivia |    1 |    1 |    1 |    1 |   NA |   NA |

Rank of Female Children in NYC Named Olivia

``` r
##Creating Ethan table
Ethan_name = baby_names %>% 
  filter(name == "Ethan")

knitr::kable(Ethan_name,
      caption = "Rank of Male Children in NYC Named Ethan")
```

| gender | ethnicity                  | name  | 2016 | 2015 | 2014 | 2013 | 2012 | 2011 |
| :----- | :------------------------- | :---- | ---: | ---: | ---: | ---: | ---: | ---: |
| MALE   | ASIAN AND PACIFIC ISLANDER | Ethan |    1 |    2 |    2 |    2 |   NA |   NA |
| MALE   | BLACK NON HISPANIC         | Ethan |    5 |    5 |    1 |    1 |   NA |   NA |
| MALE   | HISPANIC                   | Ethan |    7 |    3 |    5 |    5 |   NA |   NA |
| MALE   | WHITE NON HISPANIC         | Ethan |   20 |   19 |   18 |   23 |   NA |   NA |

Rank of Male Children in NYC Named Ethan
