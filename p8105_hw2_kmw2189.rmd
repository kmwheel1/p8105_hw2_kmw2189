...
mean_unemploy = mean(pull(unemploy_data, unemploy_pct))
min_unemploy = min(pull(unemploy_data, unemploy_pct))
max_unemploy = max(pull(unemploy_data, unemploy_pct))
...
The data contained in Problem 2 summarizes the seats held by each U.S political party, the S&P stock growth, and the U.S. unemployment rate over time. 
...
The S&P stock dataset shows that the average close was `r round(mean_close, digits = 2)` points with a high of `r round(snp_max, digits = 2)` and a low of `r round(snp_min, digits = 2)`.
The unemployment dataset shows the unemployment rate of the U.S per month. The maximum unemployment rate was `r max(pull(unemploy_data, unemploy_pct))`
